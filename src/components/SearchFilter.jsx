...
const SearchFilter = ({searchTerm, setSearchTerm}) => {
  return (
    <>
      <div className="mb-4 p-4 bg-gray-900 rounded-2xl shadow-xl border border-y-gray-800">
        <div className="flex items-center border border-gray-700 rounded-xl overflow-hidden focus-within:ring-4 focus-within:ring-orange-600/50 transition duration-300 bg-gray-800">
          ...
          <input
            ...
            className="w-full p-3 outline-none text-white bg-gray-800 placeholder-gray-500 text-base font-medium"
